...
TestMat_Comp = Composition('BaZrO3')
...
TestMat_Ener = -43.5064 # Placeholder, insert the correct value here
...
with open('Anode_BaZrO3.txt', 'w') as out_file:
...
# Write results to file
with open('Cathode_BaZrO3.txt', 'w') as out_file:
    print(TestMat_Comp, file=out_file)
...
# locked_Chem_Potential_X = {'X': CO2_Ener_X}
